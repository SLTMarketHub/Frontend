        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            <div className="relative w-[95%] max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 animate-fadeIn">
                ...
                <h2 className="text-3xl font-bold text-center text-blue-700 mb-2">
                    {fromGoogle ? "Complete Google Signup" : "Complete Your Signup"}
                </h2>
                ...
                {step === "OTP" && (
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3 rounded-lg font-medium text-white bg-blue-600 hover:bg-blue-700 transition-all duration-200 disabled:opacity-70 shadow-sm hover:shadow-md"
                        >
