  ...
  return (
    ...
    >
      <img
        ...
        alt={props.productName || props.name || "Product"}
        className="w-full h-36 object-cover mb-4 rounded-t-lg"
      />

      <h6
        className="text-lg font-semibold mb-1 text-center px-2 truncate"
        title={props.productName || props.name || "Product Name"}
      >
        {props.productName || props.name || "Product Name"}
      </h6>
      ...
      <div className="px-4 pb-2">
        ...
        <p className="text-blue-900 font-bold text-center text-lg">
          {props.resolvedPrice || props.productPrice || "Rs. 999.90"}
        </p>
      </div>
